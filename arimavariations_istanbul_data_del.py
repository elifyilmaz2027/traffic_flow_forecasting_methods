...
def armodel(train_data, test_data):
    ...
    pd.DataFrame(train_predictions).to_csv("point_forecasts/ar_istanbul_data_del_train.csv")
    pd.DataFrame(test_predictions).to_csv("point_forecasts/ar_istanbul_data_del_train.csv")
...
def armamodel(train_data, test_data):
    ...
    pd.DataFrame(train_predictions).to_csv("point_forecasts/arma_istanbul_data_del_train.csv")
    pd.DataFrame(test_predictions).to_csv("point_forecasts/arma_istanbul_data_del_test.csv")
    return train_predictions, test_predictions
...
def arimamodel(train_data, test_data):
    ...
    pd.DataFrame(train_predictions2).to_csv("point_forecasts/arima_istanbul_data_del_train.csv")
    pd.DataFrame(test_predictions2).to_csv("point_forecasts/arima_istanbul_data_del_test.csv")
...
def sarimamodel(data):
    ...
    pd.DataFrame(train_predictions2).to_csv("point_forecasts/sarima_istanbul_data_del_train.csv")
    pd.DataFrame(test_predictions2).to_csv("point_forecasts/sarima_istanbul_data_del_test.csv")
    return train_predictions2, test_predictions2
