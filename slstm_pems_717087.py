...
x, y = training_data[673:,:8], training_data[673:,-1]
...
pd.DataFrame(train_predict).to_csv("point_forecasts/slstm_pems_717087_train.csv")
pd.DataFrame(test_predict).to_csv("point_forecasts/slstm_pems_717087_test.csv")
pd.DataFrame(losses).to_csv("slstm_loss_pems_717087.csv")
