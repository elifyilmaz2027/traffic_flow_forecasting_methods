...
train_predictions.to_csv("point_forecasts/xgboost_istanbul_data_del_train.csv")
test_predictions.to_csv("point_forecasts/xgboost_istanbul_data_del_test.csv")
