...
train_predictions.to_csv("point_forecasts/xgboost_istanbul_data_mean_sdsh_train.csv")
test_predictions.to_csv("point_forecasts/xgboost_istanbul_data_mean_sdsh_test.csv")
